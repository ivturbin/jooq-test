...
public class ViewCoreCaseRecord extends TableRecordImpl<ViewCoreCaseRecord> {
    ...
    /**
     * Setter for <code>passport_international.view_core_case.version</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.version</code>.
     * Реализация оптимистической блокировки
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.invalid_id</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.invalid_id</code>.
     * Признак корректности дела: 0 - корректное, 1 - отменено, 2 - скрытое
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.invalid_dt</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.invalid_dt</code>.
     * Дата инвалидации дела
     */
     ...
     */
    public void setParentCoreCaseId(Long value) {
        set(14, value);
    }
     ...
     * <code>passport_international.view_core_case.parent_core_case_id</code>.
     */
    public Long getParentCoreCaseId() {
        return (Long) get(14);
    }
    ...
    /**
     * Setter for <code>passport_international.view_core_case.case_no</code>.
     * Номер дела
     */
    ...
    /**
     * Getter for <code>passport_international.view_core_case.case_no</code>.
     * Номер дела
     */
     ...
     */
    public void setCaseArchiveNo(String value) {
        set(19, value);
    }
     ...
     * <code>passport_international.view_core_case.case_archive_no</code>.
     */
    public String getCaseArchiveNo() {
    ...
    /**
     * Setter for <code>passport_international.view_core_case.person_id</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.person_id</code>.
     * Физлицо, которому оказывается услуга
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.src_id</code>.
     * Источник
     */
    ...
    /**
     * Getter for <code>passport_international.view_core_case.src_id</code>.
     * Источник
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.action_ind</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.action_ind</code>.
     * Индикатор операции DML(I-insert,D-delete,U-update)
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.eff_dttm</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.eff_dttm</code>.
     * Дата начала действия периода
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.exp_dttm</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.exp_dttm</code>.
     * Дата окончания действия периода
     */
    ...
    /**
     * Setter for <code>passport_international.view_core_case.region_id</code>.
     * Регион
     */
    ...
    /**
     * Getter for <code>passport_international.view_core_case.region_id</code>.
     * Регион
     */
     ...
     */
    public void setSourceCaseCode(String value) {
        set(38, value);
    }
     ...
     * Идентификатор дела в источнике
     */
    public String getSourceCaseCode() {
        return (String) get(38);
    }

    /**
     * Setter for <code>passport_international.view_core_case.source_id</code>.
    ...
    /**
     * Getter for <code>passport_international.view_core_case.source_id</code>.
     * Идентификатор источника
     */
     ...
     */
    public void setFederalCode(String value) {
        set(40, value);
    }
    ...
    /**
     * Create a detached ViewCoreCaseRecord
     */
    public ViewCoreCaseRecord() {
        super(ViewCoreCase.VIEW_CORE_CASE);
    }

    /**
     * Create a detached, initialised ViewCoreCaseRecord
     */
    public ViewCoreCaseRecord(Long coreCaseId, Integer version, Long invalidId, Boolean inChecklistBool, BigDecimal dataCorrectedCodeNval, Boolean fromDraftBool, Long caseTypeId, Long departmentId, Long caseStatusId, Long createSupplierId, Long receptionSupplierId, LocalDate receptionDt, LocalDate invalidDt, LocalDate cessationDt, Long parentCoreCaseId, Long cessationReasonId, String cessationUser, String invalidUser, String caseNo, String caseArchiveNo, String cessationBasisDesc, String commentDesc, Long caseReasonId, Long personId, Boolean cancelledBool, Long srcId, OffsetDateTime createDttm, OffsetDateTime modifyDttm, String actionInd, OffsetDateTime effDttm, OffsetDateTime expDttm, String createUser, String updateUser, Long personStatusId, String departmentCode, Long corePersonDocId, Long regionId, String applicationNo, String sourceCaseCode, Long sourceId, String federalCode) {
        super(ViewCoreCase.VIEW_CORE_CASE);
        ...
        setSourceCaseCode(sourceCaseCode);
        setSourceId(sourceId);
        setFederalCode(federalCode);
