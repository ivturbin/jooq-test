...
public class Shedlock extends TableImpl<ShedlockRecord> {
    ...
    /**
     * The reference instance of <code>passport_international.shedlock</code>
     */
    ...
    /**
     * The column <code>passport_international.shedlock.name</code>.
     */
    public final TableField<ShedlockRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>passport_international.shedlock.lock_until</code>.
     */
    ...
    /**
     * The column <code>passport_international.shedlock.locked_at</code>.
     */
    ...
    /**
     * The column <code>passport_international.shedlock.locked_by</code>.
     */
    ...
    /**
     * Create an aliased <code>passport_international.shedlock</code> table
     * reference
     */
    ...
    /**
     * Create a <code>passport_international.shedlock</code> table reference
     */
    public Shedlock() {
